...
<div class="card shadow mb-4">
    <div class="card-body">
        <?= session()->get('pesan'); ?>
        <form action="/dashboard/updateKasbon" method="post">
            <?= csrf_field(); ?>
            <input type="hidden" name="id" id="id" value="<?= $kasbon['bu_id']; ?>">
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select required name="kaskecil" id="kaskecil" class="form-control <?= $validation->hasError('kaskecil') ? 'is-invalid' : ''; ?>">
                            ...
                            foreach ($kasKecil as $row) { ?>
                                <option value="<?= $row['kk_id']; ?>" <?= $kasbon['bu_kaskecil'] == $row['kk_id'] ? 'selected' : ''; ?>>(<?= $row['kk_nomor']; ?>) <?= strtoupper($row['usr_nama']); ?></option>
                            <?php } ?>
                        </select>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input required type="text" name="tanggal" id="tanggalSelect" class="form-control <?= $validation->hasError('tanggal') ? 'is-invalid' : ''; ?>" value="<?= old('tanggal') ? old('tanggal') : date('d-m-Y', strtotime($kasbon['bu_tanggal'])); ?>">
                        <div class="invalid-feedback">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input required type="text" name="nomor" id="nomor" class="form-control <?= $validation->hasError('nomor') ? 'is-invalid' : ''; ?>" value="<?= old('nomor') ? old('nomor') : $kasbon['bu_nomor']; ?>">
                        <div class="invalid-feedback">
                    ...
                    <div class="form-group">
                        ...
                        <select required name="tukang" id="tukang" class="form-control selectpicker <?= $validation->hasError('tukang') ? 'is-invalid' : ''; ?>" data-live-search="true">
                            ...
                            <?php foreach ($tukangModel->orderBy('tk_nama', 'ASC')->findAll() as $row) { ?>
                                <option value="<?= $row['tk_id']; ?>" <?= $kasbon['bu_tukang'] == $row['tk_id'] ? 'selected' : ''; ?> data-tokens="<?= strtoupper($row['tk_nama']); ?>"><?= strtoupper($row['tk_nama']); ?></option>
                            <?php } ?>
                        </select>
                        <div class="invalid-feedback">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input required type="text" name="nominal" id="nominal" class="form-control <?= $validation->hasError('nominal') ? 'is-invalid' : ''; ?>" value="<?= old('nominal') ? old('nominal') : $kasbon['bu_nominal']; ?>">
                        <div class="invalid-feedback">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <textarea name="uraian" id="uraian" class="form-control <?= $validation->hasError('uraian') ? 'is-invalid' : ''; ?>" rows="1"><?= $kasbon['bu_keterangan']; ?></textarea>
                        <div class="invalid-feedback">
                    ...
                    <div class="form-group">
                        ...
                        <select name="debet" id="debet" class="form-control <?= $validation->hasError('debet') ? 'is-invalid' : ''; ?> selectpicker" data-live-search="true">
                            ...
                            foreach ($rekeningModel->orderBy('rek_kode', 'ASC')->findAll() as $row) { ?>
                                <option value="<?= $row['rek_id']; ?>" <?= $kasbon['bu_debet'] == $row['rek_id'] ? 'selected' : ''; ?> data-tokens="(<?= strtoupper($row['rek_kode']); ?>) <?= strtoupper($row['rek_nama']); ?>">(<?= strtoupper($row['rek_kode']); ?>) <?= strtoupper($row['rek_nama']); ?></option>
                            <?php } ?>
                        </select>
                        <div class="invalid-feedback">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select name="kredit" id="kredit" class="form-control <?= $validation->hasError('kredit') ? 'is-invalid' : ''; ?> selectpicker" data-live-search="true">
                            ...
                            <?php
                            foreach ($rekeningModel->orderBy('rek_kode', 'ASC')->findAll() as $row) { ?>
                                <option value="<?= $row['rek_id']; ?>" <?= $kasbon['bu_kredit'] == $row['rek_id'] ? 'selected' : ''; ?> data-tokens="(<?= strtoupper($row['rek_kode']); ?>) <?= strtoupper($row['rek_nama']); ?>">(<?= strtoupper($row['rek_kode']); ?>) <?= strtoupper($row['rek_nama']); ?></option>
                            <?php } ?>
                        </select>
                        <div class="invalid-feedback">
