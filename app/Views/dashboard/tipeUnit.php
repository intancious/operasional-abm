...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h5 text-uppercase mb-0 text-gray-800">
        &nbsp;<?= $title_bar; ?>
        <a href="#" class="addTipeUnit" data-toggle="modal" data-target="#tipeUnitModal"><i class="fas fa-plus-circle ml-2"></i></a>
        <a href="/dashboard/tipeUnit"><i class="fas fa-sm fa-sync-alt fa-sm ml-2"></i></a>
    </h1>
    <ol class="breadcrumb">
                        ...
                        foreach ($types as $row) : ?>
                            <tr>
                                ...
                                <td class="text-uppercase">
                                    <?php if (in_array("editTipeUnit", $akses)) { ?>
                                        <a href="#" data-id="<?= $row['type_id']; ?>" class="editTipeUnit" data-toggle="modal" data-target="#tipeUnitModal">
                                            <?= $row['type_nama']; ?>
                                        </a>
                                    <?php } else {
                                        echo $row['type_nama'];
                                ...
                                <td>
                                    <?php if (in_array("deleteTipeUnit", $akses)) { ?>
                                        <form class="d-inline ml-1" action="/dashboard/deleteTipeUnit" method="post">
                                            <?= csrf_field(); ?>
...
<div class="modal fade" id="tipeUnitModal" tabindex="-1" role="dialog" aria-labelledby="tipeUnitModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header bg-primary text-white">
                <h5 class="modal-title text-uppercase" id="tipeUnitModalLabel"></h5>
            ...
            <form action="" method="post">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="nama">Tipe Unit</label>
