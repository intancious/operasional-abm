...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h5 text-uppercase mb-0 text-gray-800">
        &nbsp;<?= $title_bar; ?>
        <a href="/dashboard/jatuhtempo"><i class="fas fa-sm fa-sync-alt fa-sm ml-2"></i></a>
    </h1>
    <ol class="breadcrumb">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="startDate" class="small">TEMPO MULAI</label>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="endDate" class="small">TEMPO SAMPAI</label>
                        ...
                        <tbody>
                            ...
                            ?>
                                    <tr class="text-uppercase">
                                        ...
                                        <td style="vertical-align: middle;"><?= date('d/m/Y H:i', strtotime($row['hs_tempo'])); ?></td>
                                        ...
                                        <!-- <td style="vertical-align: middle;"><?= number_format($ongkir, 2, ',', '.'); ?></td> -->
