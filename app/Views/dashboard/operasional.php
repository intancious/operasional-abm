...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h5 text-uppercase mb-0 text-gray-800">
        &nbsp;<?= $title_bar; ?>
        <a href="/dashboard/addOperasional"><i class="fas fa-sm fa-plus-circle ml-2"></i></a>
        <a href="/dashboard/operasional"><i class="fas fa-sm fa-sync-alt fa-sm ml-2"></i></a>
    </h1>
    <ol class="breadcrumb">
                            ...
                            ?>
                                    <tr class="text-uppercase">
                                        ...
                                        <td style="vertical-align: middle;">
                                            <a href="/dashboard/editOperasional/<?= $row['tl_id']; ?>">
                                                <?= $row['tl_nomor']; ?>
                                            </a>
                                        </td>
                                        <td style="vertical-align: middle;">
                                        ...
                                        <td style="vertical-align: middle;">
                                            <form class="d-inline ml-1" action="/dashboard/deleteOperasional" method="post">
                                                <?= csrf_field(); ?>
                                                <input type="hidden" name="_method" value="DELETE">
                                                <input type="hidden" name="id" value="<?= $row['tl_id']; ?>">
